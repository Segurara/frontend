...
export function ProductPage({ onHome, onPrivacy, onTerms }: ProductPageProps) {
  ...
  return (
    <div className="site-shell product-shell">
      {/* Product Page Navigation (shared Header) */}
      <Header onProduct={onHome} onHome={onHome} />
...
{`{
  ...
  "drift_delta": "+410% entropy deviation from 30d baseline"
      ...
      {/* Product Page Footer (shared Footer) */}
      <Footer onHome={onHome} onPrivacy={onPrivacy} onTerms={onTerms} />
    </div>
  );
}
