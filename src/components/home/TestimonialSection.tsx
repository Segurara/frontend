...
export function TestimonialSection() {
  const quotes = [['The relationship graph turned a pile of disconnected alerts into a timeline I could actually walk an analyst through.', 'Dana Whitfield', 'Security Lead, Fintech Operations'], ['We stopped guessing whether an API call was part of the same incidentnp Segurara links the evidence before we ask.', 'Marcus Okafor', 'Head of Application Security'], ['The AI assistant suggests the right next question. It keeps our investigations grounded in evidence, not hunches.', 'Priya Raman', 'Staff Incident Responder']] as const;
